    ...
    <div class="col-md-7">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-center my-4 p-3 border rounded bg-white shadow-sm" style="max-width: 260px; margin: 20px auto; border-radius: 15px;">
                    ...
                    <span class="badge bg-light text-dark border font-weight-normal mt-2 px-2 py-1" style="font-size: 0.75rem; border-radius: 10px;">
                ...
                <div class="d-flex justify-content-between mt-3">
                    <a href="{{ route('user.riwayat_beli') }}" class="btn btn-outline-secondary">
                        ← Riwayat Pembelian
                    </a>
