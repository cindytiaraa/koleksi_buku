        ...
        <div class="card">
            <div class="card-body text-center py-5">
                <div class="mx-auto mb-3 d-flex align-items-center justify-content-center rounded-circle"
                    ...
                    <i class="mdi mdi-account text-white" style="font-size:2.5rem;"></i>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8"><span class="badge badge-blue">Petugas Perpustakaan</span></div>
                </div>
                <div class="row">
                    <div class="col-sm-4 text-muted small">Bergabung Sejak</div>
                    <div class="col-sm-8 fw-600">{{ Auth::user()->created_at ? Auth::user()->created_at->format('d M Y') : '-' }}</div>
                </div>
            </div>
        </div>
    </div>
